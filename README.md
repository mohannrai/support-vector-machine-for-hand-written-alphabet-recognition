...
I would encourage you to learn concepts of Support Vector Machine which couldn’t be explored completely in this article by clicking on this link for my [free Data Science](https://www.imurgence.com/home/courses) and [Machine Learning video courses](https://www.imurgence.com/home/course/certificate-program-in-business-analytics-using-r/37). While we have used the kernlab package and created the classifier, there is a lot of mathematics involved starting from vector space to kernel tricks. We have worked on the implementation of the classifier but you should certainly learn the conceptual part of Support Vector Machine and other interesting algorithms.
